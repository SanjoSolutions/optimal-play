...
import optimalPlay.cards.*;
import optimalPlay.characters.TheDefault;
import optimalPlay.events.IdentityCrisisEvent;
import optimalPlay.potions.PlaceholderPotion;
import optimalPlay.relics.BottledPlaceholderRelic;
import optimalPlay.relics.DefaultClickableRelic;
import optimalPlay.relics.PlaceholderRelic;
import optimalPlay.relics.PlaceholderRelic2;
import optimalPlay.util.IDCheckDontTouchPls;
import optimalPlay.util.TextureLoader;
import optimalPlay.variables.DefaultCustomVariable;
import optimalPlay.variables.DefaultSecondMagicNumber;
...
public class DefaultMod implements
    ...
    private static final String MODNAME = "Optimal Play";
    private static final String AUTHOR = ""; // And pretty soon - You!
    ...
    private static final String ATTACK_DEFAULT_GRAY = "optimalPlayResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "optimalPlayResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "optimalPlayResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "optimalPlayResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "optimalPlayResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "optimalPlayResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "optimalPlayResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "optimalPlayResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "optimalPlayResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "optimalPlayResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "optimalPlayResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "optimalPlayResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "optimalPlayResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "optimalPlayResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "optimalPlayResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "optimalPlayResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "optimalPlayResources/images/char/defaultCharacter/skeleton.json";
