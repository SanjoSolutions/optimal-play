...
import optimalPlay.patches.relics.BottledPlaceholderField;
import optimalPlay.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static optimalPlay.DefaultMod.makeRelicOutlinePath;
import static optimalPlay.DefaultMod.makeRelicPath;
